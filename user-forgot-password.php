...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM officerstbl WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update officerstbl set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<div class="col-md-12">
<h4 class="header-line">officer Password Recovery</h4>
</div>
</div>
